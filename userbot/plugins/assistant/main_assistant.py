...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message=
            "You Can Deploy Friday In Heroku By Following Steps Below, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [
...
async def starkisnoob(event):
    ...
    if not is_he_added(user_id):
        ...
        await tgbot.send_message(
            user_id, "Congrats!! You Have Been Unblacklisted By My Master.")
